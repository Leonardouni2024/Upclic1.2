  ...
  return (
    <>
      <article
        ...
        className="group bg-[#17132e] rounded-lg border border-white/5 hover:border-white/20 hover:-translate-y-1 transition-all duration-200 ease-out flex flex-col justify-between overflow-hidden relative h-full text-white"
      ...
      >
        ...
        <div
          ...
          className="relative w-full aspect-square p-5 sm:p-6 bg-[#17132e] flex items-center justify-center cursor-pointer overflow-hidden border-b border-white/5"
        >
          <img
            src={imgSrc}
            alt={product.name}
        ...
        {/* Card Body Details */}
        <div className="p-3.5 sm:p-4 flex-1 flex flex-col justify-between bg-[#17132e]">
