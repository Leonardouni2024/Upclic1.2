...
export const translations = {
  ES: {
    ...
    heroSubtitle: "Activación oficial y entrega en 10 a 30 minutos con claves 100% originales. Garantía de por vida y soporte técnico especializado.",
    heroInstantDelivery: "Entrega en 10-30 min",
    ...
    bestSellersSubtitle: "Software con mayor demanda y entrega en 10 a 30 minutos garantizada",
    ...
    instantEmailDelivery: "Entrega de clave digital a tu correo en 10 a 30 minutos",
    ...
    emailDelivery: "Entrega por Email (10 a 30 min)",
    ...
    checkoutSubtitle: "Completa tus datos para recibir tu clave digital por email (10 a 30 min)",
    ...
    // Footer
    footerDesc: "Tienda líder en distribución oficial de licencias digitales de software Microsoft con entrega en 10 a 30 minutos.",
    ...
    digitalDeliverySubtitle: "Ingresa tus datos para recibir tu clave oficial y guía de instalación por correo.",
    ...
    instantDigitalDeliveryLabel: "Entrega digital por correo (10 a 30 min):",
    instantDigitalDeliveryDesc: "Te enviaremos tu clave de 25 caracteres, enlace oficial y comprobante a este correo en 10 a 30 minutos.",
    ...
    deliveryTimeNotice: "Licencia digital enviada a tu correo en 10 a 30 minutos",
    digitalLicensesSubtitle: "Licencias digitales oficiales y software original",
    ...
    productFaqTitle1: "¿Cómo y en cuánto tiempo recibo la licencia?",
    productFaqAns1M365: "Será enviada a tu correo electrónico tras confirmar el pago en un lapso de 10 a 30 minutos, con tus credenciales oficiales de acceso y la guía paso a paso.",
    productFaqAns1Default: "Será enviada a tu correo electrónico tras confirmar el pago en un lapso de 10 a 30 minutos, con tu clave original de 25 caracteres, enlace oficial de Microsoft e instrucciones de activación.",
    productFaqTitle2: "¿Cómo realizo el pago?",
    productFaqAns2: "Seleccionas 'Comprar ahora' o agregas al carrito, completas tu correo de entrega y pagas a través de Mercado Pago (tarjeta de crédito/débito, banca móvil o billeteras). La confirmación es en tiempo real.",
    ...
    productFaqAns4: "Cuentas con garantía oficial de activación de 1 año. Ante cualquier inconveniente técnico durante la activación, te asistimos de inmediato o te proporcionamos una clave de reemplazo.",
    ...
    guaranteedDelivery: "Entrega en 10-30 min",
    secureProtectedShipping: "Entrega digital segura y protegida",
    techSupport: "Soporte Técnico",
    personalizedRemoteAssistance: "Asistencia remota personalizada",
    privacyAndDeliveryNote: "Privacidad y entrega garantizada: Tus datos están protegidos y se usan exclusivamente para enviarte tu licencia y emitir tu comprobante.",
    guaranteedActivationBadge: "Activación oficial garantizada",
    license100Original: "Licencia 100% Original de Software",
    instantDigitalDeliveryPill: "Entrega digital en 10 a 30 min",
  ...
  EN: {
    ...
    heroSubtitle: "Official digital activation with 100% genuine keys delivered in 10 to 30 mins. Lifetime warranty and specialized tech support.",
    heroInstantDelivery: "10-30 Min Delivery",
    ...
    bestSellersSubtitle: "Highest demand software with guaranteed delivery in 10 to 30 minutes",
    ...
    instantEmailDelivery: "Digital license delivery to your email in 10 to 30 minutes",
    ...
    emailDelivery: "Email Delivery (10 to 30 min)",
    ...
    checkoutSubtitle: "Complete your details to receive your digital product key in 10 to 30 minutes",
    ...
    // Footer
    footerDesc: "Leading store in official digital distribution of Microsoft software licenses with delivery in 10 to 30 minutes.",
    ...
    digitalDeliverySubtitle: "Enter your email to receive your official product key, receipt, and guide in 10 to 30 minutes.",
    ...
    instantDigitalDeliveryLabel: "Digital email delivery (10 to 30 min):",
    instantDigitalDeliveryDesc: "We will send your official 25-character product key and official Microsoft download link to this email in 10 to 30 minutes.",
    ...
    productFaqTitle1: "How and when do I receive the license?",
    productFaqAns1M365: "It will be sent to your email after payment confirmation in 10 to 30 mins with your official access credentials and step-by-step guide.",
    productFaqAns1Default: "It will be sent to your email after payment confirmation in 10 to 30 mins with your original 25-character key and activation instructions.",
    productFaqTitle2: "How do I pay?",
    productFaqAns2: "Select 'Buy Now' or add to cart, fill in your delivery email, and pay securely via Mercado Pago. Confirmation is in real-time.",
    ...
    productFaqAns4: "You have a 1-year official activation guarantee. In case of any technical issues during activation, we will assist you immediately or provide a replacement key.",
    ...
    guaranteedDelivery: "10-30 Min Delivery",
    ...
    instantDigitalDeliveryPill: "Digital delivery in 10 to 30 min",
...
export const PRODUCT_TRANSLATIONS_EN: Record<string, ProductTranslationData> = {
  ...
  'prod-combo-win11-office2024': {
    ...
    features: [
      ...
      '2 independent digital keys with email delivery in 10 to 30 min',
